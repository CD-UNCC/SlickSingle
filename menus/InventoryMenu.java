...
public class InventoryMenu extends BasicGameState {
	...
	private void renderGrid(GameContainer container, Graphics g, int currentX,
			int currentY) {
	...
	private void renderItems(GameContainer container, Graphics g, int currentX,
			int currentY) throws SlickException {
